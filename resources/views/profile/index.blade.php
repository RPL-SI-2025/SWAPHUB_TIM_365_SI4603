...
@section('content')
  ...
  <!-- Main Content -->
  <div class="flex flex-col md:flex-row gap-5 px-4 md:px-24 py-10 bg-gray-50">
    <!-- Sidebar -->
    <aside class="w-full h-fit md:w-1/5 bg-white rounded-lg shadow p-6 overflow-auto max-h-[80vh]">
      ...
      <nav class="space-y-2 text-sm text-gray-700">
        ...
        <a href="{{ route('notifikasi.index') }}"
          ...
          <svg class="w-6 h-6 transition duration-300 ease-in-out" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
            ...
            <path class="hidden" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    <!-- Profile Section -->
    <section class="w-full h-fit md:w-3/4 bg-white rounded-lg shadow p-6">
        ...
        <div class="flex flex-col md:flex-row gap-6">
          ...
          <div class="flex flex-col items-center">
            ...
            <button type="submit" id="submitBtn"
              class="text-sm mt-4 px-3 py-1 bg-primary text-white rounded hover:bg-primary-hover hidden">
              Submit Photo
            </button>
          </div>
            ...
            <div>
              ...
              <div class="grid grid-cols-3 gap-2 items-center">
                ...
                <a data-modal-target="editNameModal" data-modal-toggle="editNameModal"
                  class="text-green-600 hover:underline text-sm text-right">
                  Ubah
                </a>
      ...
      <form action="{{ route('logout') }}" method="POST" class="mt-4">
        @csrf
        <button type="submit"
          class="flex items-center gap-2 text-white bg-gradient-to-r from-red-400 via-red-500 to-red-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2">
          <svg class="w-[25px] h-[25px] text-white-800" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
  ...
  <script>
    ...
    fileInput.addEventListener('change', function() {
      if (fileInput.files.length > 0) {
        submitBtn.classList.remove('hidden'); // Munculkan tombol
      } else {
        submitBtn.classList.add('hidden'); // Sembunyikan lagi jika tidak ada file
      }
    });
  </script>
@endsection
