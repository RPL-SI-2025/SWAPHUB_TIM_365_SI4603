      ...
      <div class="mt-6">
        ...
        @if (Auth::user()->id != $barang->id_user && $barang->status_barang == 'tersedia')
          <a href="{{ route('penukaran.create', $barang->id_barang) }}"
            class="bg-blue-500 text-white px-4 py-2 rounded">Minta Tukar</a>
          <button class="bg-green-500 hover:bg-green-600 text-white px-4 py-2 rounded text-xs add-to-wishlist-btn"
