      ...
      <div class="mb-8 flex justify-between items-center">
        <div class="flex items-center space-x-3">
          ...
          <h1 class="text-3xl font-bold text-gray-800">
            Detail Riwayat <span class="bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-blue-800">Penukaran</span>
          </h1>
        </div>
        ...
        <div>
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div class="bg-white border border-gray-200 rounded-3xl p-6 hover:shadow-lg transition-shadow duration-200">
              ...
              @php
                $ratingPenawar = App\Models\RatingPengguna::where('id_penukaran_barang', $history->penukaran->id_penukaran)
            ...
            <div class="bg-white border border-gray-200 rounded-3xl p-6 hover:shadow-lg transition-shadow duration-200">
              ...
              @php
                $ratingDitawar = App\Models\RatingPengguna::where('id_penukaran_barang', $history->penukaran->id_penukaran)
