...
<div class="px-4 md:px-24 py-10">
    <!-- Header -->
    <div class="mb-6">
        <h1 class="text-3xl font-bold mb-4">Daftar Laporan Penipuan</h1>
        <div class="flex justify-between items-center">
            <a href="{{ route('laporan_penipuan.create') }}" class="bg-gray-500 text-white px-4 py-2 rounded hover:bg-gray-600 flex items-center gap-2">
