  ...
  <div class="max-w-8xl mx-auto mt-10 mb-12 px-6 md:px-16 flex flex-col md:flex-row gap-8">
    ...
    <div class="w-full bg-white rounded-lg shadow-lg p-8 flex-1">
      ...
      <div class="grid grid-cols-2 md:grid-cols-4 gap-4" id="wishlist-container">
        ...
        @endforeach
        <a href="{{ route('home') }}"
          class="h-48 w-full rounded-lg bg-gray-200 flex items-center text-center justify-center text-gray-500 cursor-pointer hover:bg-gray-300 transition duration-200 ease-in-out">
          + New Collection
        </a>
      </div>
    </div>
